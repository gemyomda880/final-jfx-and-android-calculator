...
{
	boolean eq=true; 
	boolean dot=true;   // if true make dot button enable esle make it disable
	...
	public void  run_cal() {
	  ...
	  c.btnEqual.setOnAction(e->{
	    	 ...
	    	 if(mathEx.check_pracktise(c.all)&&mathEx.IsCorrect(c.all))
	    	 {
    ...
    c.btlog.setOnAction(e->{
     ...
     c.btnStyle.setOnAction(e->{
    	 ...
    	 /*Application.setUserAgentStylesheet(getClass().getResource("app.css")
			       .toExternalForm());*/
    	 c.scene.setUserAgentStylesheet("app.css");
    	 ...
    	 if(c.counter==2)
    	 {
	    	 /*Application.setUserAgentStylesheet(getClass().getResource("app4.css")
				       .toExternalForm());*/
    		 c.scene.setUserAgentStylesheet("app4.css");
    	 ...
    	 if(c.counter==3)
    	 {
	    	/* Application.setUserAgentStylesheet(getClass().getResource("app3.css")
	    	 ...
	    	 c.scene.setUserAgentStylesheet("app3.css");
	    	 ...
	    	 c.taNote.setStyle(" -fx-background-color:black");
	    	 c.btnAdd.setStyle("-fx-background-color:#48EA8E");
	    	 c.btnSub.setStyle("-fx-background-color:#48EA8E");
	    	 c.btnMod.setStyle("-fx-background-color:#48EA8E");
	    	 c.btnMul.setStyle("-fx-background-color:#48EA8E");
	    	 c.btnDiv.setStyle("-fx-background-color:#48EA8E");
	    	 c.btnClear.setStyle("-fx-background-color:#48EA8E; ");	
	    	 c.btnDel.setStyle("-fx-background-color:#48EA8E ");
			 c.btdot.setStyle("-fx-background-color:#48EA8E; ");
    	 ...
    	 if(c.counter==4)
    	 {
	    	/* Application.setUserAgentStylesheet(getClass().getResource("app2.css")
				       .toExternalForm());*/
    		 c.scene.setUserAgentStylesheet("app2.css");
    	 ...
    	 if(c.counter==5)
    	 {
    		 /*Application.setUserAgentStylesheet(getClass().getResource("app5.css")
				       .toExternalForm());*/
    		 c.scene.setUserAgentStylesheet("app5.css");
    		 ...
    		 c.btnEqual.setStyle("-fx-background-color:#666666; ");
    		 c.counter=0;
	...
	/* sci_cal.btnNum[1].setOnAction(e->{
	 ...
	 sci_cal.btnDiv.setOnAction(e->{
	    	sci_cal.s="أ·";sci_cal.ss.push(s_cal.s);
	    	sci_cal.all=s_cal.all.concat(s_cal.s);
	    	sci_cal.taNote.setText(s_cal.all);
	     });
